...
public class ClassificacaoViewHelper implements IViewHelper {
	...
	public EntidadeDominio getEntity(HttpServletRequest request) {
		...
		// pegar as prioridades classificadas pelo usuário e associá-las ao seu
		// perfil, utilizando
		...
		usuario.setExecutarWizard(false); // para não entrar automaticamente em
											// classificações no próximo login
